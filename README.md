<div class="problem-statement">
    ...
    <p>
        Each furniture type might have its own unique shipping cost calculation logic. For example:
    </p>
    <ul>
        <li><strong>Chairs:</strong> Might be lightweight and have a flat shipping rate.</li>
        <li><strong>Sofas:</strong> Might be bulky and require a distance-based shipping cost calculation.</li>
    </ul>
    <p>
    ...
    <ul>
        ...
        <li><strong>DO NOT USE ABSTRACT CLASSES.</strong></li>
